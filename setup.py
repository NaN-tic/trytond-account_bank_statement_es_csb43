...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    download_url='https://github.com:trytonspain/trytond-account_bank_statement_es_csb43',
    ...
    project_urls = {
       "Source Code": 'https://github.com:trytonspain/trytond-account_bank_statement_es_csb43'
    },
    classifiers=[
